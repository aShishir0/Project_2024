document.addEventListener('DOMContentLoaded', function () {
    ...
    function addDirectionBox() {
        ...
        directionBox.innerHTML = `
            <textarea type="text" placeholder="Direction ${directionNumber + 1}"></textarea>
        `;
        ...
        imageBox.innerHTML = `
            ...
            <input class="direction-photo-input" type="file" name="direction_photo[]" accept="image/*" style="display:none;">
        `;
